//package oms.mmc.fortunetelling.fate.baduanjin.model.entity;
//
...
//
//import oms.mmc.fortunetelling.fate.baduanjin.R;
//import oms.mmc.fortunetelling.fate.baduanjin.alarm.Alarms;
//
///**
// * Author: meyu
// * Date:   16/3/1
...
// * 用户保存用户设置的提醒信息
// */
//@JsonIgnoreProperties(ignoreUnknown = true) public class Notification extends Entity{
//
//    // 对应的公共的每一列的映射
//    public int        id;
...
//            if (mDaysCode == 0) {
//                return showNever ?
//                        context.getText(R.string.alarm_never).toString() : "";
//            }
//
//            // every day
//            if (mDaysCode == 0x7f) {
...
//                            context.getText(R.string.alarm_day_concat));
//                }
//            }
//            return ret.toString();
//        }
